...
export default function EditProductScreen(props) {
    console.log('data produk : ',props.route.params.product)
    ...
    return (
        <ImageBackground style={{ width: '100%', height: '100%', backgroundColor: '#F7F6ED' }}>
            <View style={{ backgroundColor: '#FFFFFF', flexDirection: 'row', height: '6%' }}>
                ...
                <Text style={{ marginLeft: 110, fontSize: 18, marginTop: 5 }}>Edit Product</Text>
                <TouchableOpacity>
                    <Image source={require('../Sample/img/menu.png')} style={{ marginLeft: '51%', height: 20, width: 20, marginTop: 10 }} />
                </TouchableOpacity>
            </View>
            ...
            <View style={{ height: '82%', backgroundColor: '#FFFFFF' }}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={{ height: '62%', marginTop: '2%' }} >
